...
public class PlayerMovement : MonoBehaviour
{
    ...
    private Renderer m_Renderer;            //Referência ao componente Renderer  //aqui não deveria ser private mesh Renderer?, pois no inspector o unico renderer q tem é o mesh?  
                                                                                  //o mesh renderer é responsavel pelo desenho ou cor do gameobject?
    //--
    ...
    private void Start()
    {
        ...
        m_PlayerHealth.Health = 50; //pq aqui mudar o valor do health q era 100?
    }
    ...
    void Rotation()
    {
        ...
        if (Input.GetKey(KeyCode.LeftArrow) || Input.GetKey(KeyCode.A))
        {
            ...
            rotation.y = -0.5f;//pq colocar -0.5f no y?
            //Executa a função Rotate passando o vetor rotation como parâmetro, multiplicando pela velocidade
            transform.Rotate(rotation * velocidade * 2); //pq multiplicar por 2?
        }
